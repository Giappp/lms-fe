...
import { LessonTableOfContents } from "@/types/response";
import { LessonType } from "@/types/enum";
import { Button } from "@/components/ui/button";
import { GripVertical, Edit, Trash, PlayCircle, FileText, Youtube, Clock } from "lucide-react";

interface SortableLessonItemProps {
  lesson: LessonTableOfContents;
  onEdit?: () => void;
  onDelete?: () => void;
  readOnly?: boolean;
}
